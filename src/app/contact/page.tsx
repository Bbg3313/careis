  ...
  return (
    <div className="space-y-12 pb-24">
      <section className="rounded-[42px] bg-[linear-gradient(145deg,#fbf3eb_0%,#eef3fa_100%)] p-10 shadow-[0_30px_90px_rgba(62,46,24,0.08)] md:p-14">
        ...
        <h1 className="display-font mt-4 text-5xl font-semibold text-stone-900 md:text-6xl">
          병원 및 클리닉 도입 문의
        </h1>
        <p className="mt-6 max-w-3xl text-base leading-8 text-stone-600 md:text-lg">
          CAREIS는 병원 유통 기반의 더마 코스메틱 브랜드로, 제품 도입 상담과 운영 방향에 맞춘
          소개를 우선합니다. 도입 문의는 아래 연락처로 접수할 수 있습니다.
        </p>
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <article className="rounded-[32px] border border-[rgba(116,88,59,0.12)] bg-white p-8 shadow-[0_18px_60px_rgba(73,53,26,0.05)]">
          ...
          <ul className="mt-5 space-y-3 text-sm leading-8 text-stone-600">
            <li>- 병원/클리닉 유통 가능 여부</li>
            <li>- 제품 포지셔닝 및 시술 병행 활용 맥락</li>
            <li>- 브랜드 소개 자료 및 상세 설명 요청</li>
            <li>- 인플루언서 공구 연계 운영 여부</li>
          </ul>
        </article>
      </section>
    </div>
