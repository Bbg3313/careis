...
export function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className={`fixed z-[110] inline-flex h-12 w-12 items-center justify-center rounded-full border border-[rgba(116,88,59,0.14)] bg-white/88 text-stone-900 shadow-[0_18px_40px_rgba(30,24,18,0.12)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:bg-white ${
        productDetailSticky
